                        ...
                        const ndn::mgmt::CommandContinuation& done)
{
  ...
  // create factory using the type of scheme
  // scheme can be one of: ether, tcp, udp
  ...
  // @@
  // Monitor the use of this function
  std::cout << "%%%%% Face Manager Face URI: " << uri.toString() << std::endl;
  // NFD_LOG_TRACE("[Face URI]: " + uri.toString());
