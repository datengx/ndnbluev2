...
private: // registry
  // CreateFunc used in ProtocolFactory::Registry definition
  // they are all defined through typedef
  // CreateFunc is a function pointer to function that return
  // unique pointer to a protocolFactory
  typedef std::function<unique_ptr<ProtocolFactory>()> CreateFunc;
  // Registry is a map that map string to function pointer
  // to function that return protocol factory
